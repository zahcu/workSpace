...
// creates YourRoom with no arguments  
  ...
  choice = int(input("Enter a Number for your Choice, Remember Both have potential Danger"););
...
def knockknock();:
// defines the variable knockknock();  
...
// defines gun room inside
  ...
  elif choices == "2" and "Shotgun" not in Backpack:
...
def Fightnumber1();:
//defines Fightnumber1 with no parameters
