...
// public static voidines the variable secretpassage(); 
  ...
  // else if the user choice is equal to 4 continue
    ...
    //(3);
    // //s the program for 3 seconds
    System.out.println("Enter 1 for Yes, or 2 to goback to secret passage.");
    choice = scan.nextInt();
...
// public static voidines gun room inside
  ...
  // 1: Pistol
  // 2: Shotgun
  System.out.println("\nEnter 1 for Pistol, Enter 2 for Shotgun");
  choice = scan.nextInt();
